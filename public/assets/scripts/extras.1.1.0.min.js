    ...
    jQuery(document).ready(function () {
        ...
        i.on("click", "li", function () {
            ...
            "primary" == t && (o = c),
                ...
                void 0 !== window.ubdChart &&
                    ...
                    (function (t) {
                        (t = l[t]),
                            (ubdChart.data.datasets[0].backgroundColor = [u(t, 0.9), u(t, 0.5), u(t, 0.3)]),
                            ubdChart.update(),
                            e(".ubd-stats__legend .ubd-stats__item:nth-child(1) i").attr("style", "color:" + u(t, 0.9) + ";"),
                            e(".ubd-stats__legend .ubd-stats__item:nth-child(2) i").attr("style", "color:" + u(t, 0.5) + ";"),
                            e(".ubd-stats__legend .ubd-stats__item:nth-child(3) i").attr("style", "color:" + u(t, 0.3) + ";");
                    })(t);
        });
        ...
        function u(e, t) {
            ...
            if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
                return 3 == (o = e.substring(1).split("")).length && (o = [o[0], o[0], o[1], o[1], o[2], o[2]]), "rgba(" + [((o = "0x" + o.join("")) >> 16) & 255, (o >> 8) & 255, 255 & o].join(",") + "," + t + ")";
        }
        e("#social-share").sharrre({
            share: { facebook: !0, twitter: !0 },
            buttons: { facebook: { layout: "button_count", action: "like" }, twitter: { count: "horizontal", via: "DesignRevision", hashtags: "bootstrap,uikit" } },
            enableTracking: !0,
            enableHover: !1,
            enableCounter: !1,
        }),
        ...
        m.setDate(m.getDate() + 1),
            t.setItem(o, !0, m),
            null === t.getItem("_sd_cs_visible") && t.setItem("_sd_cs_visible", !0, m),
            "false" !== t.getItem("_sd_cs_visible") && e(".color-switcher").addClass("visible"),
            setTimeout(function () {
